...
import WonTokenContractABI from "../contracts/WonToken.json";
...
export const WonTokenContract = new ethers.Contract(WONTOKEN_ADDRESS, WonTokenContractABI.abi, infuraProvider);
